...
<%--
 ...
 <%
 	if (mdao.update(mvo, request.getParameter("userid_old"))) {
 		response.sendRedirect("../common/messages.jsp?msg=ModOK&title=Success");
 	} else {
 		response.sendRedirect("../common/messages.jsp?msg=ModFail&title=Failed");
 	}
 %>